...
export default class BookCategoryScreen extends React.Component {
  constructor(props){
    super(props);
      ...
      <ScrollView
        ...
        contentContainerStyle={styles.products}>
          ...
          renderItem={({ item }) => (
            ...
            onPress={() => this.props.navigation.navigate('Search', { genre: item, searchtype:"category"})}
          ...
          <Block flex card style={[styles.imageContainer, styles.shadow]}>
            ...
            <Text size={12}  >{item.CategoryName}</Text>
            </ImageBackground>
